...
const HeaderPage = () => {
    ...
    useEffect(() => {
        if (JSON.parse(localStorage.getItem('profile'))) {
            ...
            setUserName(JSON.parse(localStorage.getItem('profile')).user_name)
        }
    ...
    return (
        <Header className="header my-header-color">
            <Row>
                ...
                <Col span={9}>
                    {/* <Link to={process.env.REACT_APP_VISIT_WEBSITE} className='return-web-button'> */}
                    <Button type="primary" className='return-web-button'
                        onClick={() => window.open(process.env.REACT_APP_VISIT_WEBSITE + '/home', "_blank")}
                    >
                        Return to Website
                    </Button>
                    {/* </Link> */}
