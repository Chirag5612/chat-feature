                ...
                <div className="page-card-view">
                    <Row>
                        <Col span={16} className="call-chat-body">
                            <Card className="chat-card-open chat-card">
                                            ...
                                            {(oppositeUserData) ?
                                                <div className="">
                                                    <div className="chat-header clearfix">
                                                        <div className="about pl-5 d-flex align-items-center ps-1 flex-wrap">
                                                            <Media src={(oppositeUserData.profileImg && (oppositeUserData.profileImg !== '' || oppositeUserData.profileImg !== null)) ? oppositeUserData.profileImg : profileIamge} className="rounded-circle" alt="" />
